...
fig.savefig(os.path.join(plotsdir('pca'), '2dim-pca.png'),
            format="png",
            bbox_inches="tight",
            dpi=200,
            pad_inches=.05)
...
fig.savefig(os.path.join(plotsdir('pca'), 'signular_val_decay.png'),
            format="png",
            bbox_inches="tight",
            dpi=200,
            pad_inches=.05)
...
fig.savefig(os.path.join(plotsdir('pca'), 'k-means.png'),
            format="png",
            bbox_inches="tight",
            dpi=200,
            pad_inches=.05)
...
fig_hist.savefig(os.path.join(plotsdir('pca'), 'cluster_time_dist.png'),
                 format="png",
                 bbox_inches="tight",
                 dpi=200,
                 pad_inches=.05)
...
for (fig, _), name in zip(figs_axs, names):
    fig.savefig(os.path.join(plotsdir('pca'), name + '.png'),
                format="png",
                bbox_inches="tight",
                dpi=100,
                pad_inches=.05)
...
fig.savefig(os.path.join(plotsdir('pca'), 'pressure_drop_count.png'),
            format="png",
            bbox_inches="tight",
            dpi=200,
            pad_inches=.05)
...
plt.legend(ncol=2, fontsize=12)
plt.gca().set_xticks(range(n_cluster))
fig.savefig(os.path.join(plotsdir('pca'), 'glitch_count.png'),
            format="png",
            bbox_inches="tight",
            dpi=200,
            pad_inches=.05)
